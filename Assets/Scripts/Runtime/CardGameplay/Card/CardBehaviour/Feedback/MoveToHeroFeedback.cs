...
{
    [CreateAssetMenu(fileName = "Move To Hero Feedback", menuName = "card/strategy/feedback/move to hero")]
    public class MoveToHeroFeedback : FeedbackStrategy
    {
        ...
        public override void Animate(PawnController caller, Action onComplete)
        {
            ...
            var targetController = GameManager.Instance.Hero;
            if (!targetController)
            {
